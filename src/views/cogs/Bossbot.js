            ...
            <>
                <div className="panel">
                    <div className="panel-content">
                        ...
                        />
                        <p>
                            There are three different tiers of golf courses a
                            toon can enter: The Front Three, The Middle Six
                            (entrance shown above), and The Back Nine (the
                            longest facility in Toontown). The shortest golf
                            course is The Front Three while the longest golf
                            course is The Back Nine. Toons can form boarding
                        ...
                        <p>
                            ...
                            11 Version 2.0, with the Club President being a
                            level 11 Version 2.0. The cogs in a golf course are
                            ...
                            options to earn a promotion on a Bossbot suit. The
                            Front Three is typically used by lower level Bossbot
                            suits, The Middle Six is typically used by mid-level
                            Bossbot suits such as the Micromanager, and The Back
                            Nine is typically used by higher level Bossbot
                            suits. Click <a href="#suit">here</a> to learn how
                        ...
                        <p>
                            ...
                            will be greeted by Good ol' Gil Giggles with two
                            Version 2.0 Cog battles on either side of the
                            kitchen. Version 2.0 cogs consist of a cog suit and
                            a skelecog, upon intial destruction, a skelecog will
                            takes the cogs place and continue to battle. Toons
                            must battle these cogs, which represent Bossbot cog
                            waiters in their white suits, until they are all
                            defeated. Proceeding these battles, toons will enter
                            the dining room wearing new waiter cog disguises.
                            Toons must feed as many cogs as possible with three
                            oil cans in 5 minutes. Once the 5 minutes is up, the
                            C.E.O. will finally realize the cog waiters are
                            actually toons! Toons disguises will be removed and
                            the remaining cogs from the previous round (if any
                            are left) will engage in battle. Finally, once those
                            remaining cogs are defeated, toons will fight the
                            C.E.O. himself by harming him with seltzer water and
                            slowing him down with golf balls. Once the C.E.O. is
                            defeated and shamefully turned into a Flunky, toons
                            will be rewarded one or more{" "}
                            <a href="#pinkslip">pink slips</a>.
                        </p>
                        <iframe
                            ...
                            width="560"
                            height="315"
                            src="https://www.youtube-nocookie.com/embed/VY-if-qpP8A"
                            frameborder="0"
                            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen
                            title="C.E.O. Play-through Part 1"
                        ></iframe>
                        <br />
                        <iframe
                            className="video-frame"
                            width="560"
                            height="315"
                            src="https://www.youtube-nocookie.com/embed/eMENI0kI9vI"
                            frameborder="0"
                            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen
                            title="C.E.O. Play-through Part 2"
                        ></iframe>
                        ...
                        <p>
                            ...
                            to collect stock options to fight the Chief
                            Executive Officer. As a toon reaches level 15, 20,
                            30, 40, and 50, they receive a laff point as a
                            reward!
                        </p>
                        <p>
                        ...
                        <p>
                            Toons can see how many pink slips they have in the
                            Gag section{" "}
                            <span>
                                <img
                                    className="book-tab"
                            ...
                            of the Shticker Book, right under how many gags they
                            have in inventory. A toon can hold up to 255 pink
                            slips at once.
                        </p>
                        <img
                            className="content-img"
                        ...
                        <p>
                            ...
                            choose which cog to fire by selecting the arrow
                            pointing to that cog. The pink slip takes the
