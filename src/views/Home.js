            ...
            <>
                ...
                <div className="panel">
                    <div className="panel-content">
                        ...
                        <h2>Activities</h2>
                        <p>
                            Head over to the <b>Activities</b> dropdown to gain
                            some insight on the various fun and extra
                            activities, that is not just cog fighting, you can
                            do in Toontown to gain some more laff points for
                            your toon. Here, you can also to learn about doodles
                            and how they can be a valuable aid for you and your
                            toon peers.
                        </p>
                        <h2>Cogs</h2>
                        <p>
                            Check out the <b>Cogs</b> dropdown to learn a lot
                            about each cog tier, their respective cog
                            headquarters, and where you can find certain cogs
                            across Toontown. Additionally, you can discover what
                            you can do in each cog headquarters and how you can
                            be successful in those types of cog related
                            activities.
                        </p>
                        <h2>Toon Tips</h2>
                        <p>
